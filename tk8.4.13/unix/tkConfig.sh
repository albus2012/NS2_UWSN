...
# installed.
TK_PREFIX='/home/yongj/NS2'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/yongj/NS2'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/yongj/NS2/tk8.4.13/unix -ltk8.4'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/yongj/NS2/lib -ltk8.4'
...
# compiled.
TK_SRC_DIR='/home/yongj/NS2/tk8.4.13'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/yongj/NS2/tk8.4.13/unix -ltkstub8.4'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/yongj/NS2/lib -ltkstub8.4'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/yongj/NS2/tk8.4.13/unix/libtkstub8.4.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/yongj/NS2/lib/libtkstub8.4.a'
