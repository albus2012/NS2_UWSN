...
static class AUV_SYNC_HeaderClass: public PacketHeaderClass{
public:
	AUV_SYNC_HeaderClass():
			PacketHeaderClass("PacketHeader/AUV_SYNC", sizeof(hdr_SYNC)) {
...
static class AUV_MissingListClass: public PacketHeaderClass {
public:
	AUV_MissingListClass():
			PacketHeaderClass("PacketHeader/AUV_ML", sizeof(hdr_MissingList)) {
				bind_offset(&hdr_MissingList::offset_);
	}
}class_AUV_ML_hdr;


AUV_MAC_WakeTimer::AUV_MAC_WakeTimer(AUV_MAC* mac,
