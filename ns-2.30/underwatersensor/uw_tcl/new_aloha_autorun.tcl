...
set opt(macc)                   [lindex $argv 2]
set opt(mac)			Mac/UnderwaterMac/$opt(macc)
...
#set opt(tr)	                	[append "~/NS2/ns-2.30/result/",[append [lindex $argv 2],".tr"]] ;# trace file
#set opt(nam)                            [append "~/NS2/ns-2.30/result/",[append [lindex $argv 2],".nam"]]  ;# nam file
#set opt(datafile)	                [append "~/NS2/ns-2.30/result/",[append [lindex $argv 2],".data"]]
set path                                "~/NS2/ns-2.30/result/"
set filename                            [lindex $argv 2];
set opt(tr)                             "$path$filename"
set opt(nam)                           "$path$filename"
set opt(datafile)                       "$path$filename"
append opt(tr)                          ".tr"
append opt(nam)				".nam"
append opt(datafile)			".data"

#set opt(nam)                            "~/NS2/ns-2.30/result/aloha.nam"  ;# nam file
#set opt(datafile)	                "~/NS2/ns-2.30/result/aloha.data"

set opt(adhocRouting)                   Vectorbasedforward ;#SillyRouting
set opt(width)                           20
set opt(adj)                             10
set opt(interval)                        0.001
set opt(depth)                           [lindex $argv 3]
...
#uwaloha class variables
Mac/UnderwaterMac/UWALOHA set Persistent 1.0;
Mac/UnderwaterMac/UWALOHA set ACKOn 0;
...
add-packet-header IP Mac LL  ARP  UWVB [lindex $argv 2]
...
for {set i 0} {$i<$opt(nn)} {incr i} {
	...
	$a_($i) cmd set-range [lindex $argv 4]
...
$node_(0) set X_  [expr [expr rand()]*1500]
$node_(0) set Y_  [expr [expr rand()]*1500]
$node_(0) set Z_  [expr [expr rand()]*$opt(depth)]
...
$node_(1) set X_  [expr [expr rand()]*1500]
$node_(1) set Y_  [expr [expr rand()]*1500]
$node_(1) set Z_  [expr [expr rand()]*$opt(depth)]
...
$node_(2) set X_  [expr [expr rand()]*1500]
$node_(2) set Y_  [expr [expr rand()]*1500]
$node_(2) set Z_  [expr [expr rand()]*$opt(depth)]
...
$node_(3) set X_  [expr [expr rand()]*1500]
$node_(3) set Y_  [expr [expr rand()]*1500]
$node_(3) set Z_  [expr [expr rand()]*$opt(depth)]
...
$node_(4) set X_  [expr [expr rand()]*1500]
$node_(4) set Y_  [expr [expr rand()]*1500]
$node_(4) set Z_  [expr [expr rand()]*$opt(depth)]
...
$node_(5) set X_  [expr [expr rand()]*1500]
$node_(5) set Y_  [expr [expr rand()]*1500]
$node_(5) set Z_  [expr [expr rand()]*$opt(depth)]
...
$node_(6) set X_  [expr [expr rand()]*1500]
$node_(6) set Y_  [expr [expr rand()]*1500]
$node_(6) set Z_  [expr [expr rand()]*$opt(depth)]
...
$ns_ at $start_time.58 "$a_(1) exp-start"
