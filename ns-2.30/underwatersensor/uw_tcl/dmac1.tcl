...
set opt(tr)	                	"~/NS2/ns-2.30/result/dmac1.tr"	;# trace file
set opt(nam)                            "~/NS2/ns-2.30/result/dmac1.nam"  ;# nam file
set opt(datafile)	                "~/NS2/ns-2.30/result/dmac1.data"
...
add-packet-header IP Mac LL  ARP  UWVB UWAN_ML UWAN_SYNC
