#this tcl script can be used to compare the RMAC and DMAC.
#you should change 
#1 set opt(mac)	Mac/UnderwaterMac/RMac
#2 add-packet-header IP Mac LL  ARP  UWVB RMAC
...
Mac/UnderwaterMac/DMac set AvgCyclePeriod 20 
#[expr 1/$opt(data_rate_)]
