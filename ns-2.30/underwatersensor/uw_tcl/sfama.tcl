...
set opt(tr)	                	"~/NS2/ns-2.30/result/sfama.tr"	;# trace file
set opt(nam)                            "~/NS2/ns-2.30/result/sfama.nam"  ;# nam file
set opt(datafile)	                "~/NS2/ns-2.30/result/sfama.data"
...
add-packet-header IP Mac LL  ARP  UWVB SFAMA
