...
set opt(mac)			Mac/UnderwaterMac/FAMA
...
set opt(tr)	                	"~/NS2/ns-2.30/result/fama.tr"	;# trace file
set opt(nam)                            "~/NS2/ns-2.30/result/fama.nam"  ;# nam file
set opt(datafile)	                "~/NS2/ns-2.30/result/fama.data"
...
add-packet-header IP Mac LL  ARP  UWVB FAMA
