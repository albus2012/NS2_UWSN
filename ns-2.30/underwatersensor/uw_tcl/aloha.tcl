...
set opt(tr)	                	"~/NS2/ns-2.30/result/aloha.tr"	;# trace file
...
Mac/UnderwaterMac/UWANMac set AvgCyclePeriod 15;#[expr 1/$opt(data_rate_)]
...
add-packet-header IP Mac LL  ARP  UWVB UWALOHA
...
$ns_ at $start_time.88 "$a_(1) exp-start"
$ns_ at $start_time.33 "$a_(2) exp-start"
$ns_ at $start_time.22 "$a_(3) exp-start"
