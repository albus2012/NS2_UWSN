...
set ptype(dbr) 64\n\
set pvals(64) dbr\n\
set ptype(uwan-sync) 65\n\
set pvals(65) uwan-SYNC\n\
set ptype(uwan-missinglist) 66\n\
set pvals(66) uwan-missinglist\n\
set ptype(uwan-hello) 67\n\
set pvals(67) uwan-hello\n\
set ptype(otman) 68\n\
set pvals(68) OTMAN\n\
set ptype(fama) 69\n\
set pvals(69) FAMA\n\
set ptype(slotted-fama) 70\n\
set pvals(70) Slotted-FAMA\n\
set ptype(uw-staticrouting) 71\n\
set pvals(71) UW-StaticRouting\n\
set ptype(uw-message) 72\n\
set pvals(72) UW-Message\n\
set ptype(uw-aloha-ack) 73\n\
set pvals(73) UW-Aloha-ACK\n\
set ptype(uw_drouting) 74\n\
set pvals(74) uw_drouting\n\
proc ptype2val {str} {\n\
global ptype\n\
