...
set ptype(dbr) 64\n\
set pvals(64) dbr\n\
set ptype(underwaterdmac) 65\n\
set pvals(65) UnderwaterDmac\n\
set ptype(auv-sync) 66\n\
set pvals(66) auv-SYNC\n\
set ptype(auv-missinglist) 67\n\
set pvals(67) auv-missinglist\n\
set ptype(auv-hello) 68\n\
set pvals(68) auv-hello\n\
set ptype(uwan-sync) 69\n\
set pvals(69) uwan-SYNC\n\
set ptype(uwan-missinglist) 70\n\
set pvals(70) uwan-missinglist\n\
set ptype(uwan-hello) 71\n\
set pvals(71) uwan-hello\n\
set ptype(otman) 72\n\
set pvals(72) OTMAN\n\
set ptype(fama) 73\n\
set pvals(73) FAMA\n\
set ptype(slotted-fama) 74\n\
set pvals(74) Slotted-FAMA\n\
set ptype(uw-staticrouting) 75\n\
set pvals(75) UW-StaticRouting\n\
set ptype(uw-message) 76\n\
set pvals(76) UW-Message\n\
set ptype(uw-aloha-ack) 77\n\
set pvals(77) UW-Aloha-ACK\n\
set ptype(uw_drouting) 78\n\
set pvals(78) uw_drouting\n\
proc ptype2val {str} {\n\
global ptype\n\
